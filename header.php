...
<head>
    ...
    <!-- icone --> 
    <link rel="shortcut icon" type="image/ico" href="./assets/images/autres/logo.jpg"/>
...
<header>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark " id="main_navbar">
        <a class="navbar-brand" href="#"><img class="logo rounded-circle img-thumbnail" src="./assets/images/autres/logo.jpg" alt="Logo du BDE" title="logo du BDE" width="100" height="100" class="d-inline-block align-top"></a><h2>FunBoardGames</h2>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav mr-auto">
                <li class="nav-item dropdown">
                 ...
                 <li class="nav-item dropdown">
                    <a class="nav-link" href="store.php"><i class="fas fa-store"></i>SHOP</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false">
                        <?php  echo isset($_SESSION["status"]) ? "<i class='fas fa-user-circle'></i>". ucfirst($_SESSION["name"])." ".ucfirst($_SESSION["surname"]) : "<i style='color: white;font-size: 1.2em' class='fas fa-user'></i> Login";?>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                       <?php
                       userPresentation();
