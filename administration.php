...
<div class="modal fade" id="ajouterProduitModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="form-group"> 
        ...
        <small id="descripHelp" class="form-text text-muted">Une brève description suffira.</small>
    </div>
    <div class="form-group"> 
        ...
        <label for="prodcat" > Category : </label>
            <select name="prodcat" required="required" id="prodcat" class="form-control">
                <option value="goodies" class="form-control">Jeux pour adultes</option>
                <option value="aliments" class="form-control">Jeux pour adolescents</option>
                <option value="boissons" class="form-control">Jeux pour enfants</option>
            </select>
       <!-- <input id="prodcat" class="form-control" name="prodcat" required="required" type="text" placeholder=""/> -->
    </div>
	<div class="form-group"> 
        <label for="prodprice" > Price : </label>
        <input id="prodprice" class="form-control" name="prodprice" required="required" type="number" value="00" min='5' max='5000'placeholder=""/>
    </div>
