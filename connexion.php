			...
			<div class="wrap-login100">
			  <div class="zone">
				<form class="login100-form connexion-form" enctype="multipart/form-data">
                    ...
                    <img class="logo rounded-circle img-thumbnail" src="./assets/images/autres/fun2.png" alt="Logo du BDE" title="logo du BDE" width="45%" height="45%" class="d-inline-block align-top">
                    </div>
